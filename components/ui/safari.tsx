      ...
      >
        ...
        >
          <path
            ...
            className="fill-[#001f3f] dark:fill-[#001a2e]"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            className="fill-[#003d66] dark:fill-[#003d66]"
          />
          <circle
            cx="27"
            cy="25"
            r="6"
            className="fill-[#ff5b5b] dark:fill-[#ff5b5b]"
          />
          <circle
            cx="47"
            cy="25"
            r="6"
            className="fill-[#ffd04d] dark:fill-[#ffd04d]"
          />
          <circle
            cx="67"
            cy="25"
            r="6"
            className="fill-[#4bff5a] dark:fill-[#4bff5a]"
          />
          <path
