...
export default function SupportComponent() {
  ...
  const quickAccessCards = [
    {
      ...
      desc: "Complete comprehensive guides.",
      href: "/docs"
    },
    {
      title: "QnA Center",
    ...
    },
    {
      ...
      desc: "Billing info and payment methods.",
      href: "/support/billing"
    },
    {
      title: "Legal & Policies",
      icon: <ScrollText className="w-6 h-6" />,
      desc: "Terms of service and policies.",
      href: "/support/legal"
    },
  ];
  ...
  const features = [
    {
      Icon: (props: any) => <img src="https://api.iconify.design/fluent-emoji-flat:wrench.svg" alt="Maintenance" {...props} className={`w-8 h-8 drop-shadow-md ${props.className || ''}`} />,
      name: "Server Maintenance",
      description: "How to perform routine maintenance to keep your server optimal.",
    ...
    {
      Icon: (props: any) => <img src="https://api.iconify.design/fluent-emoji-flat:waving-hand.svg" alt="Intro" {...props} className={`w-8 h-8 drop-shadow-md ${props.className || ''}`} />,
      name: "Introduction",
      description: "Learn the basics of setting up your first server.",
      href: "/docs/intro",
      cta: "Start Learning",
      background: (
        <div className="absolute inset-0 overflow-hidden rounded-3xl opacity-50 group-hover:opacity-70 transition-opacity duration-500">
    ...
    {
      Icon: (props: any) => <img src="https://api.iconify.design/fluent-emoji-flat:package.svg" alt="Package" {...props} className={`w-8 h-8 drop-shadow-md ${props.className || ''}`} />,
      name: "Select Package",
      description: "Confused about choosing a package? Check this guide.",
      href: "/docs/packages",
      cta: "View Details",
      background: (
        <div className="absolute inset-0 overflow-hidden rounded-3xl opacity-50 group-hover:opacity-70 transition-opacity duration-500">
    ...
    {
      Icon: (props: any) => <img src="https://api.iconify.design/fluent-emoji-flat:gear.svg" alt="Config" {...props} className={`w-8 h-8 drop-shadow-md ${props.className || ''}`} />,
      name: "Server Config",
      description: "Optimize your server configuration for gaming.",
      href: "/docs/config",
      cta: "Configure",
      background: (
        <div className="absolute inset-0 overflow-hidden rounded-3xl opacity-50 group-hover:opacity-70 transition-opacity duration-500">
    ...
    {
      Icon: (props: any) => <img src="https://api.iconify.design/fluent-emoji-flat:shield.svg" alt="Security" {...props} className={`w-8 h-8 drop-shadow-md ${props.className || ''}`} />,
      name: "Security Rules",
      description: "Secure your server from DDoS attacks and intrusions.",
      href: "/docs/security",
      cta: "Secure It",
      background: (
        <div className="absolute inset-0 overflow-hidden rounded-3xl opacity-50 group-hover:opacity-70 transition-opacity duration-500">
  ...
  const searchData = [
    {
      ...
      title: "Game Host",
      desc: "Run high-performance gaming sessions.",
      keywords: ["game", "gaming", "host", "server"]
    },
    {
      icon: <Code className="w-5 h-5" />,
      title: "App Host",
      desc: "Custom environment application hosting.",
      keywords: ["app", "application", "host", "web"]
    },
    {
      icon: <Server className="w-5 h-5" />,
      title: "Private Node",
      desc: "Full control of dedicated private nodes.",
      keywords: ["private", "node", "dedicated", "server"]
    },
    {
      icon: <Container className="w-5 h-5" />,
      title: "VPS",
      desc: "Flexible & scalable virtual servers.",
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.main
        ...
        ref={containerRef}
        className="flex flex-col items-center w-full min-h-screen bg-gray-950 text-white font-sans selection:bg-purple-500/30 overflow-hidden"
      >
          ...
          <div className="w-full flex flex-col items-center mb-16 relative">
            ...
            >
              <div className={`relative group transition-all duration-300 ${isFocused ? 'scale-[1.01]' : ''}`}>
                <div className={`absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl opacity-30 blur transition duration-500 ${isFocused ? 'opacity-70' : 'group-hover:opacity-60'}`} />
                ...
                <div className="relative flex items-center bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl">
                  ...
                  <input
                    type="text"
                    placeholder="Search for guides, tutorials, or services..."
                    value={query}
             ...
             >
                <div className="space-y-3">
                   ...
                   <p className="text-gray-400 max-w-lg">
                      Learn the basics of server setup and service management with our interactive guides.
                   </p>
                </div>
