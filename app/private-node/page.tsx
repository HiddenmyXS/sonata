...
export default function PrivateNodePage() {
  const [activeTier, setActiveTier] = useState<TierKey>("primus");
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <motion.div 
          animate={{ 
            background: activeTier === 'nano' ? 'radial-gradient(circle, rgba(16, 185, 129, 0.15) 0%, transparent 70%)' :
                        activeTier === 'primus' ? 'radial-gradient(circle, rgba(14, 165, 233, 0.15) 0%, transparent 70%)' :
